...
class create_song(unittest.TestCase):
    ...
    def test_create_song(self):
        ...
        self.create(wd, name="song_A", iswc="Q-548.132.789-0", asap="U70_S4XJQTR.1GW_P", ascap="GJ_7.031C46TSW58",
                    bmi="13_E7C_W68RSI50H_U", sesac="EX.2136TH.UIS54C-0", note="TEST TEXT")
    ...
    def create(self, wd, name, iswc, asap, ascap, bmi, sesac, note):
        # create song
        ...
        wd.find_element_by_id("song_iswc_identification_new").send_keys(iswc)
        ...
        wd.find_element_by_id("song_asap_identification_new").send_keys(asap)
        ...
        wd.find_element_by_id("song_ascap_identification_new").send_keys(ascap)
        ...
        wd.find_element_by_id("song_bmi_identification_new").send_keys(bmi)
        ...
        wd.find_element_by_id("song_sesac_identification_new").send_keys(sesac)
        ...
        wd.find_element_by_css_selector("textarea.form-control._3N_4MUdz6Is-muISLxDGRP").send_keys(note)
